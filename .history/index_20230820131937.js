...
document.getElementById("btnKetQua").onclick = function () {
  ...
  var ketQua = '';
  if (ketQua.trungTuyen) {
  console.log('Thí sinh trúng tuyển với số điểm đạt được: ' + ketQua.diemDatDuoc);
} else {
  console.log('Thí sinh không trúng tuyển với số điểm đạt được: ' + ketQua.diemDatDuoc);
};
